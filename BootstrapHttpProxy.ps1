...
[System.Environment]::SetEnvironmentVariable('HTTPS_PROXY', $httpProxyServer, [System.EnvironmentVariableTarget]::Machine)
...
certutil.exe -addstore -f "CA" "$tempDir\MicCodSigPCA2011_2011-07-08.crt"
